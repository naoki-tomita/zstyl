...
export declare const styled: {
    ...
    a: <T_1>(template: TemplateStringsArray, ...values: (string | number | ((props: T_1 & Partial<HTMLAnchorElement>) => (string | number)))[]) => Component<T_1 & Partial<HTMLAnchorElement>>;
    abbr: <T_2>(template: TemplateStringsArray, ...values: (string | number | ((props: T_2 & Partial<HTMLElement>) => (string | number)))[]) => Component<T_2 & Partial<HTMLElement>>;
    address: <T_3>(template: TemplateStringsArray, ...values: (string | number | ((props: T_3 & Partial<HTMLElement>) => (string | number)))[]) => Component<T_3 & Partial<HTMLElement>>;
    area: <T_4>(template: TemplateStringsArray, ...values: (string | number | ((props: T_4 & Partial<HTMLAreaElement>) => (string | number)))[]) => Component<T_4 & Partial<HTMLAreaElement>>;
    article: <T_5>(template: TemplateStringsArray, ...values: (string | number | ((props: T_5 & Partial<HTMLElement>) => (string | number)))[]) => Component<T_5 & Partial<HTMLElement>>;
    aside: <T_6>(template: TemplateStringsArray, ...values: (string | number | ((props: T_6 & Partial<HTMLElement>) => (string | number)))[]) => Component<T_6 & Partial<HTMLElement>>;
    audio: <T_7>(template: TemplateStringsArray, ...values: (string | number | ((props: T_7 & Partial<HTMLAudioElement>) => (string | number)))[]) => Component<T_7 & Partial<HTMLAudioElement>>;
    b: <T_8>(template: TemplateStringsArray, ...values: (string | number | ((props: T_8 & Partial<HTMLElement>) => (string | number)))[]) => Component<T_8 & Partial<HTMLElement>>;
    base: <T_9>(template: TemplateStringsArray, ...values: (string | number | ((props: T_9 & Partial<HTMLBaseElement>) => (string | number)))[]) => Component<T_9 & Partial<HTMLBaseElement>>;
    bdi: <T_10>(template: TemplateStringsArray, ...values: (string | number | ((props: T_10 & Partial<HTMLElement>) => (string | number)))[]) => Component<T_10 & Partial<HTMLElement>>;
    bdo: <T_11>(template: TemplateStringsArray, ...values: (string | number | ((props: T_11 & Partial<HTMLElement>) => (string | number)))[]) => Component<T_11 & Partial<HTMLElement>>;
    blockquote: <T_12>(template: TemplateStringsArray, ...values: (string | number | ((props: T_12 & Partial<HTMLElement>) => (string | number)))[]) => Component<T_12 & Partial<HTMLElement>>;
    body: <T_13>(template: TemplateStringsArray, ...values: (string | number | ((props: T_13 & Partial<HTMLBodyElement>) => (string | number)))[]) => Component<T_13 & Partial<HTMLBodyElement>>;
